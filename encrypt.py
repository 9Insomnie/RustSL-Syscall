...
def build_base_parser(plugin_names):
    ...
    p.add_argument("-e", "--encode", default="base64", choices=["base64", "base32", "hex", "urlsafe_base64", "none"],
...
def main():
    ...
    elif args.encode == "urlsafe_base64":
        final = base64.urlsafe_b64encode(final)

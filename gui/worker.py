...
class WorkerThread(QThread):
    ...
    def _build_features_list(self):
        ...
        # syscall method feature
        syscall_map = get_syscall_feature_map()
        default_syscall = get_default_value('syscall_method') or ''
        syscall_choice = self.params.get('syscall_method', default_syscall)
        if syscall_choice:
            syscall_feature = syscall_map.get(syscall_choice)
            if syscall_feature:

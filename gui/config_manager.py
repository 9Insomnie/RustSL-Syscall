...
def load_plugins_manifest():
    ...
    syscall_methods = data.get('syscall_methods') or []
    ...
    return {
        ...
        'syscall_methods': syscall_methods,
...
def get_syscall_methods():
    manifest = load_plugins_manifest()
    return manifest.get('syscall_methods', [])


def get_syscall_feature_map():
    manifest = load_plugins_manifest()
    return {s['id']: s['feature'] for s in manifest.get('syscall_methods', [])}

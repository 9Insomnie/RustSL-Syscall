...
from .ui_components import (
    ...
    create_syscall_method_combobox,
...
class LoaderGUI(QWidget):
    ...
    def init_ui(self):
        ...
        layout.addWidget(self._create_syscall_group())
    ...
    def _create_syscall_group(self):
        syscall_group = QGroupBox('Syscall Method')
        syscall_layout = QHBoxLayout()
        self.syscall_box = create_syscall_method_combobox()
        self.syscall_box.setToolTip('Select syscall resolution method')
        syscall_layout.addWidget(self.syscall_box)

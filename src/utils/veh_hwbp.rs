...
pub unsafe fn register_veh() -> Result<VehGuard, String> {
...
pub unsafe fn execute_with_hwbp(ntdll: *mut u8, func_hash: u32, callback: &mut dyn FnMut(*mut u8) -> i32) -> Result<(), String> {

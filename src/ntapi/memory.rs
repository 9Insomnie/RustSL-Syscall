...
pub fn alloc_virtual_memory_at(process_handle: isize, base_addr: usize, size: usize, protection: u32) -> RslResult<usize> {
...
pub fn protect_virtual_memory(process_handle: isize, base_addr: usize, size: usize, new_prot: u32) -> RslResult<u32> {
...
pub fn map_view_of_section(section_handle: isize, size: usize, protection: u32) -> RslResult<*mut u8> {
	...
	match map_status {
		Some(status) if status >= 0 => {
			if base_ptr.is_null() {
				Err(RslError::Other(obfstr!("NtMapViewOfSection returned null pointer").to_string()))
			} else {
...
pub fn free_virtual_memory(process_handle: isize, base_addr: *mut u8, size: usize) -> RslResult<()> {
...
pub fn read_virtual_memory(process_handle: isize, base_addr: usize, buffer: &mut [u8]) -> RslResult<usize> {
...
pub fn write_virtual_memory(process_handle: isize, base_addr: usize, buffer: &[u8]) -> RslResult<usize> {
